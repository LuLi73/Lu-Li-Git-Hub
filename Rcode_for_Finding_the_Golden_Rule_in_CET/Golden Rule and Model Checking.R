...
#From the p-values, it was found that Questions 5, 6, 9 from CET-A were significantly associated with Aetiology 5
#Question 4 from CET-B was significantly associated with Aetiology 4
#These 4 items were used to form the "golden rule"
...
# logistic model 1 (using the "golden rule" plus covariates to predict Aetiology 5)
...
# logistic model 2 (using all CET-A and CET-B items plus covariates to predict Aetiology 5)
...
# logistic model 3 (using the "golden rule" plus covariates to predict Aetiology 4)
...
# logistic model 4 (using all CET-A and CET-B items plus covariates to predict Aetiology 4)
