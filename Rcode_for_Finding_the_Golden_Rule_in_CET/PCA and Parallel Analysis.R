...
# C is the polychoric correlation matrix for CET-A, computed in Polychoric correlations.R
...
# M is the polychoric correlation matrix for CET-B, computed in Polychoric correlations.R
